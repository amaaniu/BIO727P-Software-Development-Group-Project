...
def create_app():
    ...
    from .run_analysis import run_analysis_bp
    ...
    app.register_blueprint(run_analysis_bp, url_prefix='/run-analysis')  # Register the run_analysis blueprint with a URL prefix for analysis routes
